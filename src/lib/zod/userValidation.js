...
export const userSchema = z.object({
  username: z
    ...
    .max(100, { message: "password should contain 100 characters only" }),
  password: z
    .string()
...
export const postSchema = z
  .array(
    z.object({
      heading: z
        .string()
        .min(1, { message: "Please enter valid heading" })
        .max(1000, { message: "heading should contain 1000 characters only" }),
      description: z
        .string()
        .min(1, { message: "Please enter valid description" }),
